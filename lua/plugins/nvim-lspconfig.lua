		...
		config = function()
			...
			local efm_config = {
				...
				settings = {
					rootMarkers = { ".git/" },
					languages = {
						solidity = { { lintCommand = "solhint -f unix", lintFormats = { "%f:%l:%c: %m" } } },
						...
						sh = {
							{ lintCommand = "shellcheck -f gcc -x", lintStdin = true, lintFormats = { "%f:%l:%c: %m" } },
						},
						javascript = { { formatCommand = "prettier --parser babel", formatStdin = true } },
						typescript = { { formatCommand = "prettier --parser typescript", formatStdin = true } },
						html = { { formatCommand = "prettier --parser html", formatStdin = true } },
